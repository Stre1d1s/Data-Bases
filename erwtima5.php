    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="erwtima5.php">Erwtima 5</a>
          </li>
          <li class="nav-item">
...
<h1 style="margin-left:20%">Εμφάνιση υπαλλήλων με τις βαθμολογίες τους, ταξινομημένους κατά φθίνουσα σειρά βαθμολογίας</h1>
