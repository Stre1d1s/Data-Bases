...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="erwtima9.php">Erwtima 9</a>
          </li>
          <li class="nav-item">
  ...
  $stmt = $conn->prepare("SELECT PLIRONI.man_id AS Id, MANAGER.monomateponimo AS Ονοματεπώνυμο,  
    COUNT(PLIRONI.erg_id) AS 'Πλύθος εργαζόμενων' 
    FROM PLIRONI 
...
<h1 style="margin-left:20%">Εμφάνιση του ονόματος και id του διευθυντή μαζί με το πλήθος εργαζομένων που διευθύνει</h1>
  ...
  <table class="table" id="mytable">
    <thead>
      <tr>
        ...
        <th scope="col">Πλύθος εργαζόμενων</th>
      </tr>
    </thead>
    <tbody>
      ...
      while ($row = $result->fetch_assoc()) { //gia kathe grammi tou select
        ...
        echo '<td>' . $row['Πλύθος εργαζόμενων'] . '</td>';
        echo '<tr>';
      }
      ?>
