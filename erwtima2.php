...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="erwtima2.php">Erwtima 2</a>
          </li>
          <li class="nav-item">
  ...
  $stmt = $conn->prepare("SELECT E.eonomateponimo AS 'Ονοματεπώνυμο Εργαζόμενου',
    (SELECT SUM(MI.poso) FROM PLIRONI P
     JOIN MISTHOS MI ON P.plir_id = MI.plir_id
     WHERE P.erg_id = E.erg_id) AS 'Συνολικό Ποσό Πληρωμών'
    FROM ERGAZOMENOS E; ");
...
<h1 style="margin-left:20%">Εμφάνιση ονοματεπώνυμου και του συνολικού μισθού κάθε υπαλλήλου</h1>

  <table class="table" id="mytable">
    <thead>
      <tr>
        <th scope="col">Ονοματεπώνυμο</th>
        <th scope="col">Συνολικό Ποσό Πληρωμών</th>
      </tr>
    </thead>
    <tbody>
