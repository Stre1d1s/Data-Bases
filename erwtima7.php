...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="erwtima7.php">Erwtima 7</a>
          </li>
          <li class="nav-item">
  ...
  <?php
  $stmt = $conn->prepare("SELECT M.monomateponimo AS 'Ονοματεπώνυμο Διευθυντή', 
    E.eonomateponimo AS 'Ονοματεπώνυμο Εργαζόμενου' 
    FROM MANAGER M 
    LEFT JOIN PERIGRAFI P ON M.man_id = P.man_id 
    LEFT JOIN ERGAZOMENOS E ON P.erg_id = E.erg_id; ");
  $stmt->execute(); //ektelesi tou erwtimatos
  $result = $stmt->get_result(); //anaktisi apotelesmatos 

  ?>

<h1 style="margin-left:20%">Εμφάνιση όλων των υπαλλήλων ονοματικά και για ποιόν διευθυντή εργάζονται</h1>
