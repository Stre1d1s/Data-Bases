...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="erwtima3.php">Erwtima 3</a>
          </li>
          <li class="nav-item">
  ...
  $stmt = $conn->prepare("SELECT E.eonomateponimo AS 'Ονοματεπώνυμο Εργαζόμενου',
    A.rating AS 'Βαθμολογία'
    FROM ERGAZOMENOS E
    JOIN PERIGRAFI P ON E.erg_id = P.erg_id 
    JOIN AKSIOLOGISI A ON P.rep_id = A.rep_id
    WHERE A.rating = (SELECT MAX(rating) FROM AKSIOLOGISI); ");
  $stmt->execute(); //ektelesi tou erwtimatos
  $result = $stmt->get_result(); //anaktisi apotelesmatos 

  ?>

<h1 style="margin-left:20%">Εμφάνιση υπαλλήλων που έχουν λάβει την υψηλότερη αξιολόγηση</h1>
